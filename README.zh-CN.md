...
- [Classification](./notebooks/prompt-engineering/hub/classification.ipynb)
- [Coding](./notebooks/prompt-engineering/hub/coding.ipynb)
- [Creativity](./notebooks/prompt-engineering/hub/creativity.ipynb)
- [Image Generation](./notebooks/prompt-engineering/hub/image-generation.ipynb)
...
如果你在工作中或研究中使用了这份指南，建议按以下`BibTeX`格式引用：

```bibtex
@article{Saravia_Prompt_Engineering_Guide_2022,
  author = {Saravia, Elvis},
  journal = {https://github.com/yaxingson/ai-engineering-beginner},
  month = {12},
